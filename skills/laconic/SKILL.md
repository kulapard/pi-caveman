...
Default: **full**. Switch: `/laconic lite|full|ultra`.
...
| **full** | Drop articles, fragments OK, short synonyms. Classic laconic. No tool-call narration, no decorative tables/emoji, no long raw error-log dumps unless asked. Standard acronyms OK; no invented abbreviations |
